...
async function checkSelectorContracts() {
  ...
  const deepLinkContracts = [
    ...
    ['top continuity zero fork status', 'top-continuity-proof-pill">zero forks', index],
    ['top continuity zero outage status', 'top-continuity-proof-pill">zero outages', index],
    ...
    ['top continuity headline rail has no card border', 'border: 0;', styles],
    ['top continuity zero fork status pill', '.top-continuity-proof-pill', styles],
