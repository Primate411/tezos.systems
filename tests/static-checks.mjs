...
async function checkSelectorContracts() {
  ...
  const deepLinkContracts = [
    ...
    ['Chambers digest panel', 'id="chambers-digest"', index],
    ['Chambers digest share button', 'id="chambers-digest-share"', index],
    ['Chambers digest storage', 'tezos-systems-chambers-digest-snapshot', app],
