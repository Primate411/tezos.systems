...
async function checkSelectorContracts() {
  ...
  const deepLinkContracts = [
    ...
    ['Etherlink Governance hash route', "hash === 'etherlink-governance'", app],
    ...
    ['Etherlink Governance card copy link', 'data-copy-hash="#etherlink-governance"', etherlinkGovernance],
    ['Etherlink Governance direct footer link', 'Direct: /#etherlink-governance', etherlinkGovernance],
    ['Etherlink Governance chamber wiring', 'openEtherlinkGovernanceChamber', etherlinkGovernance],
    ['Etherlink Governance active FAST contract', 'KT19oUVQPnVLuUBYXrBVd46WJnNAMpqkKSwo', etherlinkGovernance],
    ['Etherlink Governance active SLOW contract', 'KT1AXRU3wLc87WNhLhVGrgqDGubLACUMUgPb', etherlinkGovernance],
    ['Etherlink Governance active Sequencer contract', 'KT1VGyd2cRSHoDnxDnSuqGJD3mL8DzcVqX98', etherlinkGovernance],
