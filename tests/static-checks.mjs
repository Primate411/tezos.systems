...
async function checkSelectorContracts() {
  ...
  const deepLinkContracts = [
    ...
    ['top continuity fixed spaces before counter', 'top-continuity-claim">uptime:</span>&nbsp;&nbsp;<strong', index],
    ['top continuity fixed spaces before origin', '</strong>&nbsp;&nbsp;<span class="top-continuity-origin"', index],
