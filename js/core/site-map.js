...
export const SITE_MAP = [
    ...
    },
    {
        ...
        group: 'Live Rooms',
        chamberCategory: 'capital',
        detail: 'Delegation and direct-staking guidance, live rate context, large moves, and the complete >10K receipt history',
        keywords: ['staking chamber', 'staking guide', 'stake', 'unstake', 'stakers', 'staking ratio', 'large stake', 'staking moves', 'delegation', 'direct staking', 'staking rewards', 'staking apy', 'how to stake', '/stake'],
        searchIntents: [
            { id: 'staking-guide', title: 'Staking Guide', href: '/stake/?view=guide', detail: 'Compare liquid delegation, frozen direct staking, reward policy, baker edge, risks, and live rate context', keywords: ['staking guide', 'how to stake tezos', 'delegation vs staking', 'direct staking', 'staking rewards', 'staking risks'], directory: true }
        ],
        starter: 3,
...
export const SITE_MAP_RELATIONS = {
    ...
    'bakers-guide': ['leaderboard', 'health', 'tz4', 'staking-chamber'],
    compare: ['pulse', 'health', 'anthology', 'staking-chamber'],
    calculator: ['staking-chamber', 'bakers-guide', 'leaderboard', 'my-tezos'],
