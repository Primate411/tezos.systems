...
import { appendCardSeal, CARD_SHARE_ICON_SVG, liveShareAPY as _liveAPY, shareSlug, trackedTezosUrl } from './share-state.js';
...
function getShareCreditHtml(brandColor) {
    ...
    return `Built by <span style="color:${brandColor};font-weight:600;">Primate</span> · RPC by <span style="color:${brandColor};font-weight:600;">Tez Capital</span>`;
}
 ...
 */
export async function captureCard(card) {
 ...
 */
export async function captureProtocolHistory(protocolName) {
    let card = null;
    try {
        await loadHtml2Canvas();
 ...
 */
export async function captureHistoricalData() {
