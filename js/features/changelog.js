...
export const CHANGELOG = [
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'Update & reload sits beside the expandable transmission and installs the newest available build in one action, without asking again for the build already loaded' }
        ]
    },
    {
        date: '2026-09-17',
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '✨', text: 'Community Funding brings TezTree campaigns and HackTez project support into one room, with project previews, prominent platform credits, direct support links, source timestamps, and campaign history' }
        ]
    },
    {
        date: '2026-09-13',
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '✨', text: 'Visit streaks now stay quiet on ordinary days and reveal rare master-number, repeating-digit, round-number, and annual landmarks as hidden signals' },
            { type: '🎨', text: 'Hidden visit signals now bloom through a theme-aware sigil, staggered digits, playful copy, reduced-motion-safe geometry, and a Share the signal keepsake' }
        ]
    },
    {
        date: '2026-08-15',
        entries: [
            ...
            { type: '🔧', text: 'Protocol Anthology keeps its accessible Chamber name inside the mobile viewport while the visual field guide cover supplies the visible title' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'Market-room tab rails now keep the newly selected view visible after rendering on narrow phones, for both pointer and keyboard navigation' }
        ]
    },
    {
        date: '2026-08-03',
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'My Tezos Portfolio now partitions TzKT full balances into spendable, staked, and unstaking XTZ without counting frozen funds twice' },
            ...
            { type: '🎨', text: 'The full-width Maxis, TezosCRP, and Tezos Domains launchers now use tighter desktop shells and compact tablet layouts with less empty space before their footer rails' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '✨', text: 'Searching for network fees, transaction costs, or gas now opens the sourced fees-by-layer surface directly' }
        ]
    },
    {
        date: '2026-07-19',
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'The mobile corner gift now has its own slot beside the top price rail, scrolls away with it, and no longer paints over telemetry or the centered header' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'My Tezos and Rewards Tracker now separate baker, staker, delegator, inactive, and no-role states; current-cycle values never borrow an older reward row, and unavailable APY inputs no longer become hard-coded estimates' },
            { type: '🔧', text: 'Chain comparisons now defer Tezos concentration to live one-third and two-thirds Network Health calculations, remove composite winner scores, date peer snapshots, and expose methodology and primary references' },
            { type: '🎨', text: 'All 14 palettes now meet small-text contrast contracts; reduced-motion disables pseudo and canvas effects; Chamber launchers use native actions; dialogs contain focus, close with Escape, and return focus to the current opener' },
            { type: '⚡', text: 'API calls now have bounded deadlines and explicit live, stale, partial, or unavailable provenance; the service worker keeps a compact bounded shell but returns an explicit failure instead of silently replaying cached API data as current' },
            { type: '🔒', text: 'HTTPS enforcement is active, HEN now owns a canonical live /hen/ route with working media policy, generated Chamber routes carry unique page schema and introductions, and GitHub CI validates static and browser contracts' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🎨', text: 'The header now promotes NFT feed into the main nav and gives elapsed mainnet age more visual weight' },
    ...
    },
	{
		...
		entries: [
            ...
            { type: '🎨', text: 'The first-screen Continuity proof now leads with elapsed mainnet days, self-amendment count, and the documented upgrade record' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🎨', text: 'The former fork and outage proof badges are gone from the top header so elapsed mainnet age can read as one small history pill' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🎨', text: 'The header history rail now stands out with a large elapsed-mainnet counter and protocol-continuity context' },
            ...
            { type: '🎨', text: 'The header history rail now starts with elapsed mainnet age, then protocol-continuity context and live stats' },
            { type: '🎨', text: 'The front-page uptime proof is now a borderless header rail instead of a large continuity card' },
            { type: '🎨', text: 'Protocol-continuity context now sits beside the Tezos Systems identity with live bakers, finality, staked share, and issuance before the command bar' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '✨', text: 'Economy now includes Baking Power and Staker + Delegator Accounts tiles for consensus weight and staking participation' },
        ]
    },
    {
        date: '2026-05-15',
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '🔧', text: 'Removed redundant badges for the Stake-o-meter, fork/outage proof claims, and duplicate days-live display' },
    ...
    },
    {
        ...
        entries: [
            ...
            { type: '✨', text: 'Protocol-continuity badge now links elapsed mainnet days with the amendment-history view' },
