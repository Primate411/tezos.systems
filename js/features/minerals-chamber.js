...
function renderBody(snapshot, { quiet = false } = {}) {
    ...
    if (quiet && body.dataset.mineralsRendered === '1') {
        body.dataset.quietRefreshing = 'true';
        quietlySyncHtml(body, markup);
        body.dataset.quietRefreshSettled = 'true';
        requestAnimationFrame(() => { if (body.isConnected) delete body.dataset.quietRefreshing; });
