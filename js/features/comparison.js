...
const COMPARISON_TWEETS_FULL = [
    ...
    { label: 'Question', text: 'What\'s more decentralized: a chain where 5-7 entities control 50% of stake, or one where governance has coordinated 21+ upgrades without a single fork?\n\ntezos.systems' },
